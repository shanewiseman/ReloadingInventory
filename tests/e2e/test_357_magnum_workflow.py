...
class BrowserApp:
    ...
    def exercise_ballistics_workflow(self, recipe, batch, firearm_name):
        ...
        self.pause()
        self.wait_for_page()
        self.assert_field_value("title", "Selenium 100 yd card")
        self.fill("title", "Selenium 125 yd card")
        self.fill("notes", "Edited calculator result from Selenium.")
        self.fill("target_distance", "125")
        self.fill("wind_speed", "5")
        self.click_button("Update calculation")
        self.assert_flash("Ballistic calculation updated.", category="success")
        self.assert_text("Selenium 125 yd card")
        self.assert_text("125 yd / 50 yd")
